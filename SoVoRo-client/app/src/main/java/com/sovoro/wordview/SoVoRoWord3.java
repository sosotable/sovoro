 ...
 * Use the {@link SoVoRoWord3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord3 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord3.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord3 newInstance(String param1, String param2) {
        SoVoRoWord3 fragment = new SoVoRoWord3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word3, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_3);
        korWord=view.findViewById(R.id.sovoro_word_kor_3);
        init();
        return view;
    }
