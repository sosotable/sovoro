 ...
 * Use the {@link SoVoRoWord4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord4 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord4.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord4 newInstance(String param1, String param2) {
        SoVoRoWord4 fragment = new SoVoRoWord4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word4, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_4);
        korWord=view.findViewById(R.id.sovoro_word_kor_4);
        init();
        return view;
    }
