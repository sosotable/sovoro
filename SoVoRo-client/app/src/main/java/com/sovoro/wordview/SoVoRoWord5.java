 ...
 * Use the {@link SoVoRoWord5#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord5 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord5.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord5 newInstance(String param1, String param2) {
        SoVoRoWord5 fragment = new SoVoRoWord5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word5, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_5);
        korWord=view.findViewById(R.id.sovoro_word_kor_5);
        init();
        return view;
    }
