 ...
 * Use the {@link SoVoRoWord2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord2 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord2.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord2 newInstance(String param1, String param2) {
        SoVoRoWord2 fragment = new SoVoRoWord2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word2, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_2);
        korWord=view.findViewById(R.id.sovoro_word_kor_2);
        init();
        return view;
    }
    public void init() {
