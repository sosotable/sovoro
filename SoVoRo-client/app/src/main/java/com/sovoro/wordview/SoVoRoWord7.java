 ...
 * Use the {@link SoVoRoWord7#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord7 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord7.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord7 newInstance(String param1, String param2) {
        SoVoRoWord7 fragment = new SoVoRoWord7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word7, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_7);
        korWord=view.findViewById(R.id.sovoro_word_kor_7);
        init();
        return view;
    }
    public void init() {
