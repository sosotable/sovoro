 ...
 * Use the {@link SoVoRoWord8#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord8 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord8.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord8 newInstance(String param1, String param2) {
        SoVoRoWord8 fragment = new SoVoRoWord8();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word8, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_8);
        korWord=view.findViewById(R.id.sovoro_word_kor_8);
        init();
        return view;
    }
    public void init() {
