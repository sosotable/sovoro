 ...
 * Use the {@link SoVoRoWord6#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord6 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord6.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord6 newInstance(String param1, String param2) {
        SoVoRoWord6 fragment = new SoVoRoWord6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word6, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_6);
        korWord=view.findViewById(R.id.sovoro_word_kor_6);
        init();
        return view;
    }
    public void init() {
