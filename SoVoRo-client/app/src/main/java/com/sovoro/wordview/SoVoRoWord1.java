 ...
 * Use the {@link SoVoRoWord1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoWord1 extends Fragment {
     ...
     * @return A new instance of fragment SoVoRoWord1.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoWord1 newInstance(String param1, String param2) {
        SoVoRoWord1 fragment = new SoVoRoWord1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_sovoro_word1, container, false);
        engWord=view.findViewById(R.id.sovoro_word_eng_1);
        korWord=view.findViewById(R.id.sovoro_word_kor_1);
        init();
        return view;
    }
    public void init() {
