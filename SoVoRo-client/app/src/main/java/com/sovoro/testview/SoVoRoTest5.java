    ...
    public SoVoRoTest5() {
        ...
        for(int i=0;i<randList.size();i++) {
            switch(randList.get(i)) {
                case 0:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(4);
                    mainWord = DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(4);
                    break;
                case 1:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_1).get(4);
                    break;
                case 2:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_2).get(4);
                    break;
                case 3:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_3).get(4);
                    break;
                default:
                    break;
            }
