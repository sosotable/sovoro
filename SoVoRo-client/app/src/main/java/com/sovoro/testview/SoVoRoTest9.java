    ...
    public SoVoRoTest9() {
        ...
        for(int i=0;i<randList.size();i++) {
            switch(randList.get(i)) {
                case 0:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(8);
                    mainWord = DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(8);
                    break;
                case 1:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_1).get(8);
                    break;
                case 2:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_2).get(8);
                    break;
                case 3:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_3).get(8);
                    break;
                default:
                    break;
            }
