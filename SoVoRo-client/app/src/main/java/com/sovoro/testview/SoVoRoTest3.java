    ...
    public SoVoRoTest3() {
        ...
        for(int i=0;i<randList.size();i++) {
            switch(randList.get(i)) {
                case 0:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(2);
                    mainWord = DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(2);
                    break;
                case 1:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_1).get(2);
                    break;
                case 2:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_2).get(2);
                    break;
                case 3:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_3).get(2);
                    break;
                default:
                    break;
            }
