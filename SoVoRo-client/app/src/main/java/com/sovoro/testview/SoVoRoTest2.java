 ...
 * Use the {@link SoVoRoTest2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoVoRoTest2 extends Fragment {
    ...
    public SoVoRoTest2() {
        ...
        for(int i=0;i<randList.size();i++) {
            switch(randList.get(i)) {
                case 0:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(1);
                    mainWord = DailyWords.dailyWordsMap.get(WordOption.MAINWORD).get(1);
                    break;
                case 1:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_1).get(1);
                    break;
                case 2:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_2).get(1);
                    break;
                case 3:
                    testWords[i]=DailyWords.dailyWordsMap.get(WordOption.TESTWORD_3).get(1);
                    break;
                default:
                    break;
            }
     ...
     * @return A new instance of fragment SoVoRoTest2.
     */
    // TODO: Rename and change types and number of parameters
    public static SoVoRoTest2 newInstance(String param1, String param2) {
        SoVoRoTest2 fragment = new SoVoRoTest2();
